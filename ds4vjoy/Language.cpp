...
void LoadLanguage() {
	I18N.APP_TITLE = GetText(IDS_APP_TITLE, L"ds4vjoy");
	...
	I18N.DS4Button = GetText(IDS_DS4_BUTTON, L"DS4 Button");
	...
	I18N.log_wait_ds4 = GetText(IDS_LOG_WAIT_DS4, L"Waiting for a valid DS4 device.");
